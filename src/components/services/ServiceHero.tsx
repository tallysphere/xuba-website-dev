...
export default function ServiceHero({
  ...
  const renderTagline = () => {
    ...
    return (
      <>
        {parts[0]}
        <span className='text-xuba-green-500 dark:text-xuba-green-400'>
          {taglineHighlight}
        </span>
        {parts[1]}
      </>
  ...
  return (
    <section className='relative min-h-[70dvh] pt-32 md:pt-0 md:h-[70dvh] flex flex-col items-center justify-center px-6 overflow-hidden bg-white dark:bg-xuba-purple-950'>
      {/* Background Elements */}
