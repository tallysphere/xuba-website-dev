...
export function Footer() {
  ...
  return (
    ...
    >
      <div className='relative z-10 mx-auto max-w-7xl text-sm text-xuba-green-600 dark:text-gray-400 md:px-8'>
        {/* Main Footer Content */}
      ...
      <p className='pointer-events-none w-screen mt-40 mb-0 pb-0 bg-linear-to-b from-xuba-green-50/50 to-xuba-green-100 bg-clip-text text-center text-[25vw] font-bold leading-[0.7] text-transparent dark:from-xuba-purple-800 dark:to-xuba-purple-950'>
        XUBA
      </p>
    </footer>
  )
