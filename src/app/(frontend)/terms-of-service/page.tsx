...
export default function TermsOfServicePage() {
  return (
    <div className='relative isolate min-h-screen bg-xuba-purple-900 flex flex-col items-center overflow-hidden'>
      ...
      {/* Header Section */}
      <div className='relative flex flex-col items-center justify-center px-4 sm:px-6 pt-32 pb-12'>
        <div className='text-xuba-green-500 text-sm font-medium tracking-[0.3em] uppercase'>
          Legal
        </div>
        <div className='text-white md:text-7xl text-4xl sm:text-5xl font-thin tracking-tight mt-4 text-center'>
          Terms of{' '}
      ...
      {/* Content Section */}
      <main className='relative w-full max-w-4xl mx-auto px-6 pb-24'>
        <div className='prose prose-invert prose-lg max-w-none'>
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              ...
              <p>
                <span className='text-white font-medium'>1.10</span>{' '}
              ...
              <p>
                <span className='text-white font-medium'>1.11</span>{' '}
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>2.1</span> The parties
              ...
              <p>
                <span className='text-white font-medium'>2.2</span> Any
              ...
              <p>
                <span className='text-white font-medium'>2.3</span> Xuba
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>3.1</span> Professional
              ...
              <div className='ml-8 space-y-3'>
                ...
                <p>
                  <span className='text-white font-medium'>3.2.4</span> such
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>4.1</span> Upon receipt
              ...
              <p>
                <span className='text-white font-medium'>4.2</span> The Client
              ...
              <p>
                <span className='text-white font-medium'>4.3</span> Xuba, prior
              ...
              <p>
                <span className='text-white font-medium'>4.4</span> Xuba may
                impose a credit limit (
                <strong className='text-white'>Credit Limit</strong>) at its
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>5.1</span> Any delivery
              ...
              <p>
                <span className='text-white font-medium'>5.2</span> Xuba, the
              ...
              <p>
                <span className='text-white font-medium'>5.3</span> Risk in any
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>6.1</span> Purchase
              ...
              <p>
                <span className='text-white font-medium'>6.2</span> Xuba may
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>7.1</span> All Goods
              ...
              <p>
                <span className='text-white font-medium'>7.2</span> For the
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>8.1</span> Xuba
              ...
              <p>
                <span className='text-white font-medium'>8.2</span> Should the
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>9.1</span> The
              ...
              <p>
                <span className='text-white font-medium'>9.2</span> The Consumer
              ...
              <p>
                <span className='text-white font-medium'>9.3</span> Except as
              ...
              <p>
                <span className='text-white font-medium'>9.4</span> Except as
              ...
              <p>
                <span className='text-white font-medium'>9.5</span> The Client
              ...
              <p>
                <span className='text-white font-medium'>9.6</span> For the
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              ...
              <div className='ml-8 space-y-3'>
                <p>
                  <span className='text-white font-medium'>10.2.1</span> cancel
                  these Terms of Trade;
                </p>
                <p>
                  <span className='text-white font-medium'>10.2.2</span> refuse
                ...
                <p>
                  <span className='text-white font-medium'>10.2.3</span> impose
                  a Credit Limit in accordance with clause 4.4;
                </p>
                <p>
                  <span className='text-white font-medium'>10.2.4</span> require
                  the Client to provide a guarantor in accordance with clause
                  12; or
                </p>
                <p>
                  <span className='text-white font-medium'>10.2.5</span> remove
                  or repossess Goods in accordance with clause 11.4.
                </p>
              </div>
              <p>
                <span className='text-white font-medium'>10.3</span> Xuba may
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>11.1</span> Title in
              ...
              <p>
                <span className='text-white font-medium'>11.2</span> The Client
                gives Xuba a security interest over:
              </p>
              <div className='ml-8 space-y-3'>
                <p>
                  <span className='text-white font-medium'>11.2.1</span> all
              ...
              <p>
                <span className='text-white font-medium'>11.3</span> The Client
                agrees to:
              </p>
              <div className='ml-8 space-y-3'>
                <p>
                  <span className='text-white font-medium'>11.3.1</span> if
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>12.1</span> Xuba may at
              ...
              <div className='ml-8 space-y-3'>
                <p>
                  <span className='text-white font-medium'>12.1.1</span> the
                  proposed Guarantor&apos;s then current financial position;
                </p>
                <p>
                  <span className='text-white font-medium'>12.1.2</span> any
                  assets then currently held by the proposed Guarantor;
                </p>
                <p>
                  <span className='text-white font-medium'>12.1.3</span> the
                  proposed Guarantor&apos;s credit history; and
                </p>
                <p>
                  <span className='text-white font-medium'>12.1.4</span> any
                  other matter that Xuba considers relevant.
                </p>
              </div>
              <p>
                <span className='text-white font-medium'>12.2</span> If the
              ...
              <p>
                <span className='text-white font-medium'>12.3</span> Any person,
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>13.1</span> The Client
              ...
              <p>
                <span className='text-white font-medium'>13.2</span> If the
              ...
              <p>
                <span className='text-white font-medium'>13.3</span> If the
              ...
              <p>
                <span className='text-white font-medium'>13.4</span> The Client
                authorises Xuba to disclose any information obtained to any
                person for the purposes set out in clause 13.1.
              </p>
              <p>
                <span className='text-white font-medium'>13.5</span> Where the
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>14.1</span> All third
                ...
                <strong className='text-white'>Manufacturer Terms</strong>).
              ...
              <p>
                <span className='text-white font-medium'>14.2</span> Should Xuba
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>15.1</span> All
              ...
              <p>
                <span className='text-white font-medium'>15.2</span> Subject to
              ...
              <p>
                <span className='text-white font-medium'>15.3</span> The Client
              ...
              <p>
                <span className='text-white font-medium'>15.4</span> Xuba may
              ...
              <p>
                <span className='text-white font-medium'>15.5</span> All
              ...
              <p>
                <span className='text-white font-medium'>15.6</span> The Client
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>16.1</span> In the
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 text-gray-300'>
              <p>
                <span className='text-white font-medium'>17.1</span> Xuba shall
              ...
              <p>
                <span className='text-white font-medium'>17.2</span> Notices,
              ...
              <div className='ml-8 space-y-3'>
                <p>
                  <span className='text-white font-medium'>17.2.1</span> if
                  delivered by hand, when so delivered;
                </p>
                <p>
                  <span className='text-white font-medium'>17.2.2</span> if sent
                  by post, on the third Working Day following posting; or
                </p>
                <p>
                  <span className='text-white font-medium'>17.2.3</span> in the
              ...
              <p>
                <span className='text-white font-medium'>17.3</span> Except as
              ...
              <p>
                <span className='text-white font-medium'>17.4</span> Failure by
              ...
              <p>
                <span className='text-white font-medium'>17.5</span> Xuba may
              ...
              <p>
                <span className='text-white font-medium'>17.6</span> If any
              ...
              <p>
                <span className='text-white font-medium'>17.7</span> These terms
              ...
              <p>
                <span className='text-white font-medium'>17.8</span> Reference
                to any Statutes includes any later amendments or changes to
                those Statutes.
              </p>
              <p>
                <span className='text-white font-medium'>17.9</span> The Client
              ...
              <p>
                <span className='text-white font-medium'>17.10</span> Xuba may
